        ...
        <div class="row">
            ...
            <div class="col-10 m-0 p-0">
                <div class="content">
                    ...
                    <iframe class="full-screen-preview_frame" src="https://webgis.digitaldesa.id/regional/public/maps" name="preview-frame" frameborder="0" noresize="noresize" data-view="fullScreenPreview" allow="geolocation 'self'; autoplay 'self'">
                    </iframe>
                </div>
            </div>
        </div>
...
setInterval(function() {
    ...
    speech.text = "Selamat datang, <?php echo $nama_lengkap; ?>! Di webgis digital desa";
