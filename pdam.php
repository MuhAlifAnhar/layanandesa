        ...
        <div class="row">
            ...
            <div class="col-10 m-0 p-0">
                <div class="content">
                    ...
                    <iframe class="full-screen-preview_frame" src="https://pdamgowa.co.id/info-tagihan" name="preview-frame" frameborder="0" noresize="noresize" data-view="fullScreenPreview" allow="geolocation 'self'; autoplay 'self'">
                    </iframe>
                </div>
            </div>
        </div>
